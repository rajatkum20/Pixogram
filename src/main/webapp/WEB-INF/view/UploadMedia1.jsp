...
<div class="profile"><img src="data:images/jpg;base64,${firstpic.encimg}" width=150px;
  height=150px;><h3 style="margin-left: 150px;margin-top: -70px; ">${username}</h3>
    ...
    <div class="account">
        <h1>UPLOAD</h1>
        <br>
        <button type="button" class="btn btn-dark btn-lg btn-block" style="margin-bottom: 10px; font-family: cursive">Single Media</button>
<button type="button" class="btn btn-secondary btn-lg btn-block"><a href="${contextPath}/multipleupload" style="color: white;text-decoration:none;">Multiple Media</a></button></div> 
   
       
      <form:form method="post" modelAttribute="uploadmedia" action="upload"  enctype="multipart/form-data">
       <div class="formm">
        <div class="container" >
            <h3>New Media Page</h3>
          <label for="browse"><b>Browse</b></label>
          <input type="file" name="file" class="btn btn-secondary" style="margin-right: 40px;margin-left: 60px;">
          ...
          <form:input type="text" style="margin-top:-110px" placeholder="Tags" path="tags"></form:input>
           <br>
