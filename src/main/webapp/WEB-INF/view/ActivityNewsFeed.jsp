...
<div class="profile"><img src="${pageContext.request.contextPath}/images/profile.png" width=150px; 
    height=150px;><h3 style="margin-left: 150px;margin-top: -70px; ">${username}</h3>
        ...
        <div class="btn-group" style="float: right;"role="group" aria-label="Basic example">
            <button type="button" class="btn btn-secondary">NEWSFEED</button>
     ...
     <br>
        ...
        <div class="account">
            <h1>ACCOUNT</h1>
            <br>
            <button type="button" class="btn btn-secondary btn-lg btn-block">Newsfeed</button>
...
<b>day &nbsp;&nbsp;&nbsp;&nbsp; date</b><br>
<input type="text" placeholder="comments are here...."><br><br><br><br><br>
<br>
<br>
<b>day &nbsp;&nbsp;&nbsp;&nbsp; date</b>
<input type="text" placeholder="comments are here...."><br><br><br><br><br><br>
<br>
<b>day &nbsp;&nbsp;&nbsp;&nbsp; date</b>
<input type="text" placeholder="comments are here...."><br><br><br><br><br>
